...
const asesmenAwalSubjektifSchema = new Schema({
    ...
    riwayatPenyakit: {
        sekarang: { type: [String], trim: true, uppercase: true },
        dahulu: { type: [String], trim: true, uppercase: true },
        keluarga: { type: [String], trim: true, uppercase: true },
    },
    riwayatMenstruasi: {
        haidTerakhir: {
            hariPertama: Date,
...
module.exports = mongoose.model('AsesmenAwalSubjektif', asesmenAwalSubjektifSchema)